...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  "/blog": {
    title: "AI Automation Blog for Australian Businesses | AI Pivot Toolbox",
  ...
  "/ai-pivot-vs-marketing-agency": {
    title: "AI Pivot Toolbox vs Traditional Marketing Agency | AI Pivot Toolbox",
  ...
  "/ai-automation-brisbane": {
    title: "AI Automation Agency Brisbane | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-sydney": {
    title: "AI Automation Agency Sydney | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-melbourne": {
    title: "AI Automation Agency Melbourne | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-perth": {
    title: "AI Automation Agency Perth | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-adelaide": {
    title: "AI Automation Agency Adelaide | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-gold-coast": {
    title: "AI Automation Gold Coast | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-canberra": {
    title: "AI Automation Agency Canberra | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-newcastle": {
    title: "AI Automation Agency Newcastle | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  "/ai-automation-hobart": {
    title: "AI Automation Agency Hobart | Voice Agents & SEO | AI Pivot Toolbox",
  ...
  // Service pages
  "/ai-voice-agents": {
    title: "AI Voice Agents Australia | 24/7 Calls from $997/mo | AI Pivot Toolbox",
  ...
  "/workflow-automation": {
    title: "Workflow Automation Australia | From $1,497/mo | AI Pivot Toolbox",
  ...
  "/ai-seo-australia": {
    title: "AI SEO Agency Australia | GEO, AEO & Rankings | AI Pivot Toolbox",
  ...
  "/aeo-answer-engine-optimisation": {
    title: "AEO Australia | Get Found on ChatGPT & Perplexity | AI Pivot Toolbox",
  ...
  "/geo-generative-engine-optimisation": {
    title: "GEO Agency Australia | Get Cited by AI Search | AI Pivot Toolbox",
  ...
  "/ai-chatbot-australia": {
    title: "AI Chatbot Australia | Website Chatbot from $597/mo | AI Pivot Toolbox",
  ...
  "/website-design-ai": {
    title: "Website Design with AI Australia | From $3,497 | AI Pivot Toolbox",
  ...
  "/app-development-australia": {
    title: "Custom AI App Development Australia | From $7,997 | AI Pivot Toolbox",
  ...
  "/ai-integrations": {
    title: "CRM & AI Integrations Australia | From $997/mo | AI Pivot Toolbox",
  ...
  // Industry pages
  "/ai-for-real-estate": {
    title: "AI Automation for Real Estate Agencies Australia | AI Pivot Toolbox",
  ...
  "/ai-for-healthcare": {
    title: "AI Automation for Healthcare Practices Australia | AI Pivot Toolbox",
  ...
  "/ai-for-legal": {
    title: "AI for Law Firms Australia | Legal Admin Automation | AI Pivot Toolbox",
  ...
  "/ai-for-accounting": {
    title: "AI for Accounting Firms Australia | Xero & MYOB | AI Pivot Toolbox",
  ...
  "/ai-for-hospitality": {
    title: "AI Automation for Hospitality Australia | AI Pivot Toolbox",
  ...
  "/ai-for-construction": {
    title: "AI for Construction Australia | Quote Automation | AI Pivot Toolbox",
  ...
  "/ai-for-finance": {
    title: "AI for Finance & Mortgage Brokers Australia | AI Pivot Toolbox",
  ...
  "/ai-for-retail": {
    title: "AI Automation for Retail & eCommerce Australia | AI Pivot Toolbox",
  ...
  "/blog/what-is-geo-generative-engine-optimisation": {
    title: "What Is GEO (Generative Engine Optimisation)? | AI Pivot Toolbox",
  ...
  "/blog/get-business-recommended-chatgpt": {
    title: "How to Get Recommended by ChatGPT & Perplexity | AI Pivot Toolbox",
  ...
  "/blog/ai-automation-small-business-australia": {
    title: "AI Automation for Small Business Australia | AI Pivot Toolbox",
  ...
  "/blog/workflow-automation-tasks-australia": {
    title: "10 Business Automations for Australian SMBs in 2026 | AI Pivot Toolbox",
  ...
  "/blog/automate-xero-with-ai-australia": {
    title: "How to Automate Xero With AI in Australia (2026) | AI Pivot Toolbox",
  ...
  "/blog/ai-for-australian-accountants": {
    title: "7 AI Workflows for Australian Accountants (2026) | AI Pivot Toolbox",
  ...
  "/blog/how-to-choose-ai-seo-agency-australia": {
    title: "How to Choose an AI SEO Agency in Australia (2026) | AI Pivot Toolbox",
  ...
  "/blog/seo-agency-vs-ai-seo-agency-australia": {
    title: "Traditional SEO Agency vs AI SEO Agency Australia | AI Pivot Toolbox",
  ...
  "/blog/what-is-a-geo-agency": {
    title: "What Is a GEO Agency? GEO for Australian Businesses | AI Pivot Toolbox",
...
export function injectMeta(distPath: string) {
  return (req: Request, res: Response, next: NextFunction): void => {
    ...
    try {
      ...
      // Inject server-side H1 (visible to non-JS crawlers, visually hidden for sighted users)
      const h1Text = meta.title.split(" | ")[0];
      const h1Html = `<h1 style="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap">${escapeHtml(h1Text)}</h1>`;
