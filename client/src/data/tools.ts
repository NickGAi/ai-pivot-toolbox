...
export const tools: Tool[] = [
  {
    ...
    description: "Human-like AI that answers, qualifies and books appointments 24/7 — integrated with your CRM and calendar. Fully managed and maintained for you.",
    price: 1497,
    billing: "monthly",
  ...
  },
  {
    ...
    description: "Full AI SEO and GEO strategy — get found on Google, ChatGPT, Perplexity and every AI search engine. Done-for-you by Australian SEO specialists.",
    price: 1997,
    billing: "monthly",
  ...
  },
  {
    ...
    description: "Instantly engage and qualify leads across SMS, email, live chat and webforms with intelligent 24/7 follow-ups. Fully managed system.",
    price: 1297,
    billing: "monthly",
    category: "Lead Conversion",
  ...
  },
  {
    ...
    description: "Automate your most time-consuming workflows — data entry, reporting, client comms — and cut manual work by up to 80%. Custom-built and managed.",
    price: 1997,
    billing: "monthly",
    category: "Automation",
  ...
  },
  {
    ...
    description: "Custom-trained chatbot that answers questions, captures leads and books appointments directly on your website. Managed and updated monthly.",
    price: 797,
    billing: "monthly",
    category: "Lead Conversion",
  ...
  },
  {
    ...
    description: "Connect your CRM, calendar, email and tools into a single automated system. Full setup, migration and ongoing management included.",
    price: 1297,
    billing: "monthly",
    category: "Automation",
